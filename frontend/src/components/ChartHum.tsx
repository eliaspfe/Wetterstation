...
export default function ChartHum( { trunc }: Props) {
    ...
    <div className="w-full h-64">
      <ResponsiveContainer>
        <LineChart data={data}>
          ...
          <YAxis label={{ value: 'Luftfeuchtigkeit %', angle: -90, position: 'middle', style: { fontSize: 12 }, dx: -15 }}/>
          ...
          <Legend />
          <Line type="monotone" dataKey="humidity" stroke="#3b82f6" name="Luftfeuchtigkeit in %" />
