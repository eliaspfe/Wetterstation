 ...
 * WIFI Settings
 **************************/
const char* WiFi_Name = "MeinPiHotspot";
const char* WiFi_Password = "12345678";
WiFiClient client;

const char* serverIP = "192.168.4.1";  // IP deines Servers
...
const char *thingspeak_API_key ="83YI202W727HVG44";                  //Your own thingspeak api_key
...
void loop() {
  ...
  if(millis() - uploadTime > 900000){
    Serial.println("---Upload Temperature Humidity every 12 seconds---");
...
void uploadDataToServer() {
  ...
  HTTPClient http;
  String url = String("http://") + serverIP + ":" + serverPort + "/upload";

  // JSON vorbereiten
  StaticJsonDocument<200> doc;
  doc["temperature"] = currentTemperature;
  doc["humidity"] = currentHumidity;
  doc["pressure"] = currentAtoms;
